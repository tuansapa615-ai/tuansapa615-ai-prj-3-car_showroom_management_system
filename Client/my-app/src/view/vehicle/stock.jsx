...
function Stock() {
  ...
  const filteredVehicles = vehicles
    .filter(vehicle => {
      ...
      const hasStatus = vehicle.status !== null;
      return matchesSearchTerm && matchesBrand && hasStatus;
    })
    .sort((a, b) => a.vehicleID - b.vehicleID); // Sorting by vehicleID in ascending order
