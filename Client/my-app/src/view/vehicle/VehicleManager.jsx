    ...
    <Container>
      ...
      <Row className="mb-3 mt-3 justify-content-center">
        ...
        <Col xs={2} className="d-flex justify-content-end">
          <Button href='./add-vehicle' className="mx-2">Add</Button>
        </Col>
      </Row>
      ...
      <Table striped bordered hover>
        ...
        <tbody>
          {filteredVehicles
            .sort((a, b) => a.vehicleID - b.vehicleID) // Sort by vehicleID
            .map(vehicle => (
              <tr key={vehicle.vehicleID}>
                ...
                <td>
                  <Button type="button" href={`./edit-vehicle/${vehicle.vehicleID}`} className="mx-2">
                    Edit
                  </Button>
                </td>
              </tr>
